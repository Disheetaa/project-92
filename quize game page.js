...
function check()
{
    ...
    if(question_turn == "player_1")
    {
        ...
        document.getElementById("player question").innerHTML = "Question Turn -" + player_2_name;
    }
    else
    {
        question_turn = "player_1";
        document.getElementById("player question").innerHTML = "Question Turn -" + player_1_name;
    }
